...
package com.mycompany.loancalci;
...
public class Loan extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jSlider3.setForeground(new java.awt.Color(255, 0, 0));
        ...
        jLabel14.setText("   ₹ 1Lac");

        jLabel15.setText("   ₹10Cr");
                            ...
                            .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                                .addGroup(javax.swing.GroupLayout.Alignment.LEADING, jPanel1Layout.createSequentialGroup()
                                    .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                                        ...
                                        .addComponent(jSlider2, javax.swing.GroupLayout.PREFERRED_SIZE, 425, javax.swing.GroupLayout.PREFERRED_SIZE))
                                    .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                                ...
                                .addGroup(javax.swing.GroupLayout.Alignment.LEADING, jPanel1Layout.createSequentialGroup()
                                    .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                                        ...
                                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                                            ...
                                            .addComponent(jSlider3, javax.swing.GroupLayout.PREFERRED_SIZE, 431, javax.swing.GroupLayout.PREFERRED_SIZE)))
        ...
        jLabel8.setText("                                  Home Loan EMI Calculator");
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Payement", "Interest", "Principal", "Balance"
            }
        ) {
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        .addContainerGap()
                        .addComponent(jLabel8, javax.swing.GroupLayout.DEFAULT_SIZE, 1079, Short.MAX_VALUE))
                    .addGroup(layout.createSequentialGroup()
    ...
    private void jSlider1MouseDragged(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jSlider1MouseDragged
        int number6;
        number6 = jSlider1.getValue();
        jTextField1.setText(Integer.toString(number6));
    }//GEN-LAST:event_jSlider1MouseDragged

    private void jSlider2MouseDragged(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jSlider2MouseDragged
       int number5;
        number5 = jSlider2.getValue();
        jTextField3.setText(Integer.toString(number5));
    ...
    private void jSlider3MouseDragged(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jSlider3MouseDragged
        ...
        int number7;
        number7 = jSlider3.getValue();
        jTextField4.setText(Integer.toString(number7));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        double loan,rate,sum1,sum2,sum3,sum4;
        int year;
        long monthly,sum;
        ...
        double months = (year)*12.0;
        double denom = (Math.pow(1+mrate, months)-1);
        sum = (long) ((mrate +  mrate/denom)*loan);
        sum1 =  year * 12;
        sum2 = sum * sum1;
        sum3 = sum2 - loan;
        monthly = (long) (sum3 + loan);
        jTextField2.setText(monthly +"");
		...
		str.append("Payment#,Interest,Principal,Balance\n");
                ...
                Integer arr[][] = new Integer[years * 12+1][4];
                for (int i = 0; i <years * 12; i++) {
			interest = (monthlyRate * balance) ;
			principal =  (monthlyPayment - interest);
			balance = balance - principal;
			arr[i][0] =  (i+1);
                        arr[i][1] = (int)(interest);
                        arr[i][2] = (int)(principal);
                        arr[i][3] = (int)(balance);
			str.append((i+1) + "," + (interest) + "," + (principal) + "," + (balance) + "\n");
             }
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        try{
            PdfWriter.getInstance(doc, new FileOutputStream(path+"Emi.pdf"));
            doc.open();
            PdfPTable tb = new PdfPTable(4);
            tb.addCell("Payment");
            tb.addCell("Interest");
            tb.addCell("Principal");
            tb.addCell("Balance");
  
            for(int k = 0;k< jTable1.getRowCount()-1;k++){
               
                String Payment = jTable1.getValueAt(k,0).toString();
                String Interest = jTable1.getValueAt(k,1).toString();
                String Principal = jTable1.getValueAt(k,2).toString();
                String Balance = jTable1.getValueAt(k,3).toString();
